...
//			data.portal.author = data.portal.author || '';
	...
	str += '<div class="panel-heading"><h3 class="panel-title">Infos über das Daten-Dashboard</h3></div>';
	str += '<div class="panel-body">';
